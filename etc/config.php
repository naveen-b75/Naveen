...
return [
    'modules' => [
        ...
        'Magento_CustomerSampleDataVenia' => 0,
        'Magento_Banner' => 1,
        ...
        'Magento_CatalogSampleDataVenia' => 0,
        ...
        'Magento_TaxSampleDataVenia' => 0,
        'Magento_TaxGraphQl' => 1,
        'Magento_TaxImportExport' => 1,
        'Magento_SalesSampleDataVenia' => 0,
        ...
        'AuroraExtensions_SimpleReturns' => 0,
        'Custom_Demo' => 1,
        'Custom_New' => 1,
        'Custom_Paylater' => 0,
        'Custom_Quantity' => 1,
        ...
        'Custom_Wishlist' => 1,
        'DEG_CustomReports' => 1,
        'Flancer32_FreeRates' => 1,
        'Helloworld_Checkout' => 0,
        'Helloworld_Commands' => 1,
        'Helloworld_Mymodule' => 1,
        'Helloworld_ShipmentAttributes' => 1,
        'HexBrain_ProductView' => 1,
