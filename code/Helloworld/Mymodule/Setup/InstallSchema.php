...
{
    const TBL_PRODUCTREPORT_DAILY = 'productreport_aggregated_daily';
    const TBL_PRODUCTREPORT_MONTHLY = 'productreport_aggregated_monthly';
    const TBL_PRODUCTREPORT_YEARLY = 'productreport_aggregated_yearly';
    ...
    {
        $tablesToCreate = [
            'daily' => self::TBL_PRODUCTREPORT_DAILY,
            'monthly' => self::TBL_PRODUCTREPORT_MONTHLY,
            'yearly' => self::TBL_PRODUCTREPORT_YEARLY
        ];
        ...
        foreach($tablesToCreate as $key => $tbl)
        {
            $table = $installer->getConnection()->newTable(
                ...
                'ProductReport Aggregated '.ucfirst($key)
            );
