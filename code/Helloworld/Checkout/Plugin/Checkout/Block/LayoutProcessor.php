<?php
namespace Helloworld\Checkout\Plugin\Checkout\Block;
...
class LayoutProcessor
{
    ...
    public function afterProcess(
        ...
        ['shippingAddress']['children']['shippingAdditional'] = [
            ...
            'children' => [
                'delivery_date' => [
                    'component' => 'Helloworld_Checkout/js/view/delivery-date-block',
                    ...
                    'children' => [
                        'form-fields' => [
                            ...
                            'children' => [
                                'delivery_date' => [
                                    'component' => 'Helloworld_Checkout/js/view/delivery-date',
                                    'config' => [
                                        'customScope' => 'delivery_date',
                                        'template' => 'ui/form/field',
                                        'elementTmpl' => 'Helloworld_Checkout/fields/delivery-date',
                                        'options' => [],
                                        'id' => 'delivery_date',
