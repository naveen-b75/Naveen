...
class Config
{
    const XPATH_FORMAT                 = 'helloworld_checkout/general/format';
    const XPATH_DISABLED               = 'helloworld_checkout/general/disabled';
    const XPATH_HOURMIN                = 'helloworld_checkout/general/hourMin';
    const XPATH_HOURMAX                = 'helloworld_checkout/general/hourMax';
    const XPATH_REQUIRED_DELIVERY_DATE = 'helloworld_checkout/general/required_delivery_date';
	const XPATH_BLACKOUT_DATES 		   = 'helloworld_checkout/holidays/blackout_dates';
